...
async def request(url: str, method: str = "GET", asjson: bool = False, body: Optional[str] = None,
                  headers: Optional[dict[str, str]] = {'Content-Type': 'application/json'}, **fetch_kwargs: Any) -> FetchResponse:
    """
